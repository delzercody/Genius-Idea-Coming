...
def create_seed_data():
    ...
    # Cooking ideas
    cooking_ideas = [
        Idea(user_id=1, category_id=cooking_category.id, title="Create a fusion cuisine dish combining Asian and Mediterranean flavors.",
            description="Experiment with ingredients and techniques from both cuisines to create a unique and flavorful fusion dish."),
        Idea(user_id=2, category_id=cooking_category.id, title="Develop a series of healthy and quick 15-minute recipes for busy individuals.",
        ...
        Idea(user_id=3, category_id=cooking_category.id, title="Organize a virtual cooking class to teach people how to make homemade pasta.",
            description="Host an online cooking class where participants can learn the art of making fresh pasta from scratch."),
        Idea(user_id=4, category_id=cooking_category.id, title="Create a cookbook specifically catering to vegan desserts.",
        ...
        Idea(user_id=5, category_id=cooking_category.id, title="Start a food blog featuring unique and lesser-known international cuisines.",
    ...
    home_improvement_ideas = [
        Idea(user_id=6, category_id=home_improvement_category.id, title="Design and build a functional home office space in a small apartment.",
        ...
        Idea(user_id=7, category_id=home_improvement_category.id, title="Renovate a bathroom to incorporate eco-friendly and sustainable design elements.",
        ...
        Idea(user_id=8, category_id=home_improvement_category.id, title="Create an outdoor entertainment area with a cozy fire pit and seating.",
        ...
        Idea(user_id=9, category_id=home_improvement_category.id, title="Install a smart home automation system to control lighting and temperature.",
        ...
        Idea(user_id=10, category_id=home_improvement_category.id, title="Build a vertical garden or living wall for a vibrant and space-efficient greenery display.",
    ...
    # Art ideas
    art_ideas = [
        Idea(user_id=11, category_id=art_category.id, title="Paint a large-scale mural depicting the history and culture of the local community.",
        ...
        Idea(user_id=12, category_id=art_category.id, title="Sculpt a public art installation using recycled materials to raise awareness about environmental sustainability.",
        ...
        Idea(user_id=13, category_id=art_category.id, title="Organize a collaborative art project that involves local artists and community members.",
        ...
        Idea(user_id=14, category_id=art_category.id, title="Experiment with abstract painting techniques using unconventional materials.",
        ...
        Idea(user_id=15, category_id=art_category.id, title="Create a series of digital illustrations inspired by science fiction and futuristic themes.",
    ...
    # Business ideas
    business_ideas = [
        Idea(user_id=16, category_id=business_category.id, title="Develop a mobile app that connects local farmers with consumers for direct produce purchases.",
        ...
        Idea(user_id=17, category_id=business_category.id, title="Launch an online marketplace for handmade crafts and artisanal products.",
        ...
        Idea(user_id=18, category_id=business_category.id, title="Start a personalized gift service that curates and delivers thoughtful gift packages for special occasions.",
        ...
        Idea(user_id=19, category_id=business_category.id, title="Create an online course platform for teaching business skills and entrepreneurship.",
        ...
        Idea(user_id=20, category_id=business_category.id, title="Start a subscription box service for entrepreneurs, providing curated resources and tools.",
    ...
    # Technology ideas
    technology_ideas = [
        Idea(user_id=21, category_id=technology_category.id, title="Develop a mobile app for language learning with interactive exercises and quizzes.",
        ...
        Idea(user_id=22, category_id=technology_category.id, title="Build a smart home security system with integrated surveillance cameras and motion sensors.",
        ...
        Idea(user_id=23, category_id=technology_category.id, title="Create a virtual reality (VR) experience for exploring historical landmarks and locations.",
        ...
        Idea(user_id=24, category_id=technology_category.id, title="Build an AI-powered chatbot for customer support and assistance.",
        ...
        Idea(user_id=25, category_id=technology_category.id, title="Design and develop a mobile app for managing personal finances and budgeting.",
